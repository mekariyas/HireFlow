...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 right-0 h-full w-72 bg-gray-900 text-white z-50 flex flex-col px-8 py-6 gap-8 shadow-2xl transition-transform duration-300 md:hidden ${sidebarOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        {/* Sidebar header */}
        ...
        <nav className="flex flex-col gap-6 text-sm font-medium">
          ...
          <div className="flex flex-col gap-3">
            ...
            <NavLink
              to="/companies/signup"
              onClick={() => setSidebarOpen(false)}
              className="pl-3 hover:text-indigo-300 transition-colors"
            >
              Sign up
            </NavLink>
            <NavLink
        ...
        <div className="flex flex-col gap-3 mt-auto">
          <NavLink
            to="/signup"
            onClick={() => setSidebarOpen(false)}
            className="text-center text-sm font-semibold border border-indigo-500 hover:border-indigo-400 py-2.5 rounded-lg transition-colors"
          >
            Sign up
          </NavLink>
          <NavLink
            to="/login"
            onClick={() => setSidebarOpen(false)}
            className="text-center text-sm font-semibold bg-indigo-600 hover:bg-indigo-700 py-2.5 rounded-lg transition-colors"
          >
            Log in
          </NavLink>
        </div>
